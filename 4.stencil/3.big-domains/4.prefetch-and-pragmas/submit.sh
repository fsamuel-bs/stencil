...
do
    ...
    mpiicc -openmp -mmic -qopt-report=5 -qopt-report-phase=vec,loop -O3 $CODE_DIR/$code_file -S
    mpiicc -openmp -mmic -O3 $CODE_DIR/$code_file -o $BIN_DIR/${code_file_parsed}_mic.o
done
