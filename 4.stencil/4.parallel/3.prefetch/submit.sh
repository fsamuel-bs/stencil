...
do
    ...
    mpiicc -g -openmp -mmic -O3 -qopt-report=4 -qopt-report-phase=vec,loop $CODE_DIR/$code_file -S
    mpiicc -g -openmp -mmic -O3 $CODE_DIR/$code_file -o $BIN_DIR/${code_file_parsed}_mic.o
done
