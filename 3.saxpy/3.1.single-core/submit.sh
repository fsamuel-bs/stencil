...
# mode: (scatter|compact|balanced). How the threads will be distributed among the cores.
...
CODE_DIR=./code/Threads-${NUM_THREADS}-Mode-${AFFINITY}
BIN_DIR=./bin/Threads-${NUM_THREADS}-Mode-${AFFINITY}
ASS_DIR=./assembly/Threads-${NUM_THREADS}-Mode-${AFFINITY}
REPORT_DIR=./report/Threads-${NUM_THREADS}-Mode-${AFFINITY}
OUTPUT_DIR=./output/Threads-${NUM_THREADS}-Mode-${AFFINITY}
